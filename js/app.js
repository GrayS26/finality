(() => {
    ...
    script_Parallax.Each = class {
        ...
        parameters(el, parameters) {
            if (parameters.axis == "v") el.style.transform = `rotate(${(parameters.direction * (this.value / parameters.coefficient)).toFixed(2)}deg) ${parameters.additionalProperties}`; else if (parameters.axis == "h") el.style.transform = `rotate(${(parameters.direction * (this.value / parameters.coefficient)).toFixed(2)}deg) ${parameters.additionalProperties}`;
        }
    };
